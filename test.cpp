...
int ackermannRecursiv(int m, int n)
{
    ...
    if (n == 0)
        ...
        return ackermannRecursiv(m - 1, ackermannRecursiv(m, n - 1));
}
...
bool compunere_alfabet(int m, int n, int M[10][10], int x[100], int y)
{
    ...
    {
        cout << endl
             << y << " este o compunere a elementelor lui x" << endl;
        parantezare_compunere(1, n, A, B, m);
        ok = true;
    }
    else
        cout << y << " nu poate fi o compunere a elementelor lui x indiferent de asociere" << endl;
    return ok;
}
    ...
    do
    {
        ...
        case 1:
            do
            {
                ...
                cout << "         Citeste optiunea din meniul 1: ";
                cin >> op1;
                switch (op1)
                {
                case 1:
        ...
        case 3:
            do
            {
                ...
                case 6:
                    ...
                    int a[10][10];
                    cout << "Numarul de coloane este n=";
                    cin >> n;
                    cout << "Numarul de linii este m=";
                    cin >> m;
                    for (int i = 0; i < n; i++)
                        for (int j = 0; j < m; j++)
                            cin >> a[i][j];
        ...
        case 6:
            do
            {
                ...
                case 3:
                {
                    ...
                    cout << "Numarul de caractere din alfabet m=";
                    cin >> m;
                    cout << "Legea de compozitie=" << endl;
                    for (int i = 1; i <= m; i++)
                        for (int j = 1; j <= m; j++)
                            cin >> M[i][j];
                    cout << "Numarul de caractere din sirul x, n=";
                    cin >> n;
                    for (int i = 1; i <= n; i++)
                        cin >> x[i];
                    cout << "Rezultatul compunerii sa fie y=";
                    cin >> y;
