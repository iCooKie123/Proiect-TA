...
void capitol3()
{
    int op3; // optiune capitol 1
    do
    {
        cout << "2. Metoda backtracking\n\n";
        cout << " 2.1. Backtracking recursiv\n";
        cout << " 2.2. \n";
        cout << " 2.3. \n";
        cout << " 2.4. \n";
        ...
        {
        case 1:
            // o problema de backtracking recursiv
            break;
        ...
        default:
            cout << "Optiune invalida cap 3!!!\n\n";
            break;
        } // end switch meniu principal

    } while (op3 != 0); // end while op2 capitol 2
}
