...
void capitol4()
{
    ...
    do
    {
        4. Divide et Impera(5 probleme obligatorii) 4.1. Quicksort 4.2. Cautare binara 4.3. Turnurile din Hanoi 4.4. Minim si maxim dintr - un sir de numare naturale 4.5. CMMDC a n numere naturale
                                                                                                                                                cin >>
            opt4;
        switch (opt4)
        {
