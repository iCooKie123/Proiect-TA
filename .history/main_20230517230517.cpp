...
case 4:
 int n;
    std::cout << "Introduceți un număr: ";
    std::cin >> n;

    int factors[100]; // Dimensiunea maximă a tabloului de factori
    int count = 0;

    primeFactorsRecursive(n, factors, count);

    std::cout << "Factorii primi ai numărului " << n << " sunt: ";
