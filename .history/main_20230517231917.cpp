...
void capitol4()
{
    ...
    do
    {
        ...
        cout << "4.3. Turnurile din Hanoi" << endl;
        cout << "4.4. Minim si maxim dintr-un sir de numare naturale" << endl;
        cout << "4.5. CMMDC a n numere naturale" << endl;
        cout<< "4.6. CMMMC a n numere naturale" << endl;
        cin >> opt4;
        switch (opt4)
        {
        case 1:
