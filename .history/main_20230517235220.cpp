...
void capitol8()
{
    ...
    std::cout << "Numarul de drepte: ";
    std::cin >> numarDrepte;

    std::cout << "Numarul de la care incep dreptele paralele: ";
    std::cin >> inceputDrepte;

    std::cout << "Numarul maxim de incercari: ";
    std::cin >> numarIncercari;

    std::cout << "Eroarea tolerata: ";
    std::cin >> eroareTolerata;

    double estimarePi = estimeazaPi(numarDrepte, inceputDrepte, numarIncercari, eroareTolerata);
    std::cout << "Estimarea valorii lui pi: " << estimarePi << std::endl;
        }
            break;
        case 2:
            break;
