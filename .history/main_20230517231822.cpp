...
void capitol4()
{
    ...
    do
    {
        cout<<"4. Divide et Impera (5 probleme obligatorii)"
        cout<<"4.1. Quicksort"
        cout<<"4.2. Cautare binara" 
        cout<<"4.3. Turnurile din Hanoi" 
        cout<<"4.4. Minim si maxim dintr-un sir de numare naturale "
        cout<<"4.5. CMMDC a n numere naturale"
        cin >> opt4;
        switch (opt4)
        {
        case 2:
