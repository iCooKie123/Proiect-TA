...
void capitol8()
{
    ...
    do
    {
        ...
        cout << "     8.4 Exemplu de alg Monte-Carlo: eliminarea nodurilor intr-un graf" << endl;
        cout << "     8.5 Exemplu de alg Las Vegas: problema reginelor (rezolvare probabilista)" << endl;
